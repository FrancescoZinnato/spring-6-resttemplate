...
public class BeerClientMockTest {
    ...
    public static class TestConfig {
        ...
        @Bean
        OAuthClientInterceptor oauthClientInterceptor(OAuth2AuthorizedClientManager authorizedClientManager, ClientRegistrationRepository clientRegistrationRepository) {
    ...
    @Test
    void testListBeerWithQueryParameter() throws JsonProcessingException {
        ...
        Page<BeerDTO> responsePage = beerClient.listBeers("ALE", null, null, null);
    ...
    private void mockGetOperation() {
        server.expect(method(HttpMethod.GET))
                .andExpect(header("Authorization", BEARER_TEST))
                .andExpect(requestToUriTemplate(URL + BeerClientImpl.GET_BEER_BY_ID_PATH, beerDTO.getId()))
                .andRespond(withSuccess(dtoJsonString, MediaType.APPLICATION_JSON));
    }
